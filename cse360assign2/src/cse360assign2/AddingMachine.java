...
public class AddingMachine {
	...
	// Your code should look like: num = num + sum / 10;
	...
	public AddingMachine () {
		...
		history = "0 "; //match the starting string history to the starting value
	}
	...
	public static void main(String[] args)
	{
		...
		System.out.println("The total is: " + test.getTotal());
